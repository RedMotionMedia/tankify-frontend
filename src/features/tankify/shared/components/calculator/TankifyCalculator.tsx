...
import MobileBottomSheet from "@/features/tankify/mobile/components/MobileBottomSheet";
import SettingsModal from "./SettingsModal";
import OnboardingModal from "./OnboardingModal";
import {getTranslations} from "@/features/tankify/shared/config/i18n";
import {calculateTankify, getProfitLevel} from "@/features/tankify/shared/lib/calc";
import {geocode} from "@/features/tankify/shared/lib/geocode";
import {useRoute} from "@/features/tankify/shared/hooks/useRoute";
import {useBottomSheet} from "@/features/tankify/shared/hooks/useBottomSheet";
import {
    gallonsToLiters,
    kmhToMph,
    litersToGallons,
...
} from "@/features/tankify/shared/lib/units";
import { eurToQuote, quoteToEur } from "@/features/tankify/shared/lib/fx";
import {
    CurrencySystem,
    FuelType,
    Language,
...
export default function TankifyCalculator() {
    ...
    // Keep initial SSR + first client render identical to avoid hydration mismatch.
    // The actual value is derived after mount in the effect below.
